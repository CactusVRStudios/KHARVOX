...
internal static class KharvoxRunner
{
        ...
        string? bhapticsApiKey = null)
    {
        ...
        EnsureNoRunningDoom();
        if (FileVersionInfo.GetVersionInfo(dllPath).ProductVersion != "1.1.0")
            throw new InvalidOperationException("The 1.1 launcher requires its matching 1.1 KharvoxLayer.dll. Extract the complete release into its own folder.");
