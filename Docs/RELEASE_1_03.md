...
`nCSV location: %TEMP%\KHARVOX-Diagnostics\movement-diagnostic-PID.csv. Collect this file separately along with the ordinary KHARVOX logs. Start through the launcher included in this package.
