...
{
    internal const string BuildId = "2026.09.20-launcher-v1.03-movement-fix";
        ...
        string? bhapticsApiKey = null)
    {
        ...
        EnsureNoRunningDoom();
        if (FileVersionInfo.GetVersionInfo(dllPath).ProductVersion != "1.0.3")
            throw new InvalidOperationException("The 1.03 launcher requires its matching 1.03 KharvoxLayer.dll. Extract the complete release into its own folder.");
