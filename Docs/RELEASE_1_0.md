# KHARVOX 1.0 Release Candidate 2
...
- Existing Custom profiles using AER switch to SFS once. Other preferences are retained, and selecting AER afterwards remains supported.
